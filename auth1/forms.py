...
class ngoUserCreationForm(UserCreationForm):
    pincode = forms.ModelChoiceField(required=True,queryset=pincode.objects.all(),widget=forms.Select(attrs={'class': 'form-control','data-label': 'City'}),label="City")
    email = forms.EmailField(required=True,max_length=30,widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Email'}), validators=[validate_email])
    ...
    phone_no = forms.CharField(validators=[phone_regex], max_length=17, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Phone number'}))
    username = forms.CharField(max_length=255,widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Username'}))
    password1 = forms.CharField(required=True,max_length=150,widget=forms.PasswordInput(attrs={'class': 'form-control', 'data-label':'Password','placeholder': 'Password'}), label= 'Password')
    password2 = forms.CharField(required=True,max_length=150,widget=forms.PasswordInput(attrs={'class': 'form-control', 'data-label':'Confirm password','placeholder': 'confirm password'}), label= 'Confirm password')
...
class donorUserCreationForm(UserCreationForm):
    pincode = forms.ModelChoiceField(queryset=pincode.objects.all(),widget=forms.Select(attrs={'class': 'form-control','data-label': 'City'}),label="City")
    email = forms.EmailField(max_length=30, required=True,widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Email'}), validators=[validate_email])
    donor_name = forms.CharField(max_length=255,widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Donor name'}))
    phone_regex = RegexValidator(regex=r'^\+?1?\d{9,15}$', message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.")
    phone_no = forms.CharField(validators=[phone_regex], max_length=17, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Phone number'}))
    username = forms.CharField(max_length=255,widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Username'}))
    password1 = forms.CharField(max_length=150,widget=forms.PasswordInput(attrs={'class': 'form-control', 'data-label':'Password','placeholder': 'Password'}), label= 'Password')
    password2 = forms.CharField(max_length=150,widget=forms.PasswordInput(attrs={'class': 'form-control', 'data-label':'Confirm password','placeholder': 'confirm password'}), label= 'Confirm password')
    class Meta(UserCreationForm.Meta):
        model = donor
