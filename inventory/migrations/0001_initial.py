    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descoins', models.PositiveBigIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('donor_to_ngo', 'donor_to_ngo'), ('ngo_to_donor', 'ngo_to_donor'), ('donor_to_us', 'donor_to_us'), ('us_to_ngo', 'us_to_ngo')], max_length=15)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='donor_permissions', to='auth.permission'),
        ),
    ]
